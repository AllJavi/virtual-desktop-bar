...
Item {
    ...
    property int cfg_DesktopLabelsCustomIconSize
    property string cfg_DesktopLabelsCustomIconPath
    ...
    GridLayout {
        ...
        RowLayout {
            ...
            CheckBox {
                id: desktopLabelsCustomIconSizeCheckBox
		enabled: cfg_DesktopLabelsStyle == 5
                checked: cfg_DesktopLabelsCustomIconSize > 0
                onCheckedChanged: cfg_DesktopLabelsCustomIconSize = checked ?
                                  desktopLabelsCustomIconSizeSpinBox.value : 0
                text: "Custom icon size:"
            }

            SpinBox {
                id: desktopLabelsCustomIconSizeSpinBox
                enabled: desktopLabelsCustomIconSizeCheckBox.enabled && 
			 desktopLabelsCustomIconSizeCheckBox.checked 
                value: cfg_DesktopLabelsCustomIconSize || 100
                minimumValue: 50
                maximumValue: 150
                suffix: " %"
                onValueChanged: {
                    if (desktopLabelsCustomIconSizeCheckBox.checked) {
                        cfg_DesktopLabelsCustomIconSize = value;
                    }
                }
            }
        }
        ...
        RowLayout {
            ...
            CheckBox {
                id: desktopLabelsCustomIconPathCheckBox
		enabled: cfg_DesktopLabelsStyle == 5
                checked: cfg_DesktopLabelsCustomIconPath
                onCheckedChanged: cfg_DesktopLabelsCustomIconPath = checked ?
                                  desktopLabelsCustomIconPathCheckBoxTextField.text : ""
                text: "Global icons path:"
            }

            UICommon.GrowingTextField {
                id: desktopLabelsCustomIconPathCheckBoxTextField
                enabled: desktopLabelsCustomIconPathCheckBox.enabled &&
                         desktopLabelsCustomIconPathCheckBox.checked
                maximumLength: 255
                text: cfg_DesktopLabelsCustomIconPath || "/usr/share/virtual-desktop-bar/desktop-icons/"
                onTextChanged: {
                    if (cfg_DesktopLabelsCustomIconPath && text) {
                        cfg_DesktopLabelsCustomIconPath = text;
                    }
                }
                onEditingFinished: cfg_DesktopLabelsCustomIconPath = text
            }
        }
